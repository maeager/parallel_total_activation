...
#PBS -N pbs_TotalActivation_105115
...
time matlab -nosplash -nodesktop -r "matlabpool close force local; matlabpool local 8; fastActivation('../HCP_10_Data/105115'); matlabpool close force; exit"
