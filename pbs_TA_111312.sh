...
#PBS -N pbs_TotalActivation_111312
...
time matlab -nosplash -nodesktop -r "matlabpool close force local; matlabpool local 8; fastActivation('../HCP_10_Data/111312'); matlabpool close force; exit"
