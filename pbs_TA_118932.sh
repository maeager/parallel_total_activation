...
#PBS -N pbs_TotalActivation_118932
...
time matlab -nosplash -nodesktop -r "matlabpool close force local; matlabpool local 8; fastActivation('../HCP_10_Data/118932'); matlabpool close force; exit"
