...
#PBS -N pbs_TotalActivation_115320
...
time matlab -nosplash -nodesktop -r "matlabpool close force local; matlabpool local 8; fastActivation('../HCP_10_Data/115320'); matlabpool close force; exit"
