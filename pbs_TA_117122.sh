...
#PBS -N pbs_TotalActivation_117122
...
time matlab -nosplash -nodesktop -r "matlabpool close force local; matlabpool local 8; fastActivation('../HCP_10_Data/117122'); matlabpool close force; exit"
