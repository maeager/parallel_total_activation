...
#PBS -N pbs_TotalActivation_100307
...
time matlab -nosplash -nodesktop -r "matlabpool close force local; matlabpool local 8; fastActivation('../HCP_10_Data/100307'); matlabpool close force; exit"
