...
#PBS -N pbs_TotalActivation_110411
...
time matlab -nosplash -nodesktop -r "matlabpool close force local; matlabpool local 8; fastActivation('../HCP_10_Data/110411'); matlabpool close force; exit"
